...
- Catalog: [T1627.001](https://attack.mitre.org/techniques/T1627/001)
...
A detection rule without an execution attempt is not a T1627.001 test.
...
1. **Applicability gate.** If none of the platforms/domains exist in scope, record `T1627.001 N/A: <reason>` and stop.
...
9. **Report.** Cite `T1627.001`, tactic, CAPEC/CWE IDs, instance, oracle, evidence path.
...
- [ ] Finding (if any) cites T1627.001
