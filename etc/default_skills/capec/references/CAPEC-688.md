...
- Catalog: [CAPEC-688](https://capec.mitre.org/data/definitions/688.html)
- CAPEC list: 3.9
...
Do **not** file "CAPEC-688" as the only finding ID. Walk every member. For each member, open `references/CAPEC-<id>.md` and run that procedure. Exhaustion = every member tested or ruled out with evidence.

## Members to test

- [CAPEC-184](CAPEC-184.md)
- [CAPEC-440](CAPEC-440.md)
- [CAPEC-444](CAPEC-444.md)
- [CAPEC-536](CAPEC-536.md)
...
- [ ] No finding uses CAPEC-688 as the only ID when a member ID applies
