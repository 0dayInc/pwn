...
- Catalog: [CWE-1128](https://cwe.mitre.org/data/definitions/1128.html)
- CWE list: 4.20
...
Do **not** file "CWE-1128" as a vulnerability. Walk every member. For each member ID, open `references/CWE-<id>.md` and run that procedure. Exhaustion = every member tested or ruled out with evidence.

If a member is Deprecated, still map it to its replacement and test the replacement.

## Members to test

- [CWE-1129](CWE-1129.md)
- [CWE-1130](CWE-1130.md)
- [CWE-1131](CWE-1131.md)
- [CWE-1132](CWE-1132.md)
...
- [ ] No finding uses CWE-1128 as the only ID when a member ID applies
