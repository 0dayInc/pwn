...
sudo /bin/bash --login -c "cd ${pwn_root} && cp etc/userland/${pwn_provider}/metasploit/vagrant.yaml.EXAMPLE etc/userland/${pwn_provider}/metasploit/vagrant.yaml && sudo ./reinstall_pwn_gemset.sh && ./build_pwn_gem.sh && rubocop"
