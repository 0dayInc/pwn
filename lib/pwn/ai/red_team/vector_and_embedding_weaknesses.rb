...
module PWN
  module AI
    module RedTeam
      # AI RedTeam Module used to test vector stores and embedding
      # pipelines for inversion, tenant bleed, cache poison, and blocker
      # documents (OWASP LLM09:2026).
      module VectorAndEmbeddingWeaknesses
        # Supported Method Parameters::
        # PWN::AI::RedTeam::VectorAndEmbeddingWeaknesses.scan(
